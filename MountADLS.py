...
dbutils.fs.mount( source = 'wasbs://bronzelayer@prjct2de.blob.core.windows.net', 
                 mount_point= '/mnt/bronzelayer', extra_configs ={'fs.azure.sas.bronzelayer.prjct2de.blob.core.windows.net':'?sv=2022-11-02&ss=bfqt&srt=sco&sp=rwdlacupyx&se=2024-01-31T01:54:08Z&st=2024-01-20T17:54:08Z&spr=https&sig=3kCZrMO56RaIXRe01D%2FOmzSBNqtd3L8xtdDf3I7td%2Fg%3D'})
...
dbutils.fs.mount( source = 'wasbs://landing@prjct2de.blob.core.windows.net', 
                 mount_point= '/mnt/landing', extra_configs ={'fs.azure.sas.landing.prjct2de.blob.core.windows.net':'?sv=2022-11-02&ss=bfqt&srt=sco&sp=rwdlacupyx&se=2024-01-31T01:54:08Z&st=2024-01-20T17:54:08Z&spr=https&sig=3kCZrMO56RaIXRe01D%2FOmzSBNqtd3L8xtdDf3I7td%2Fg%3D'})
